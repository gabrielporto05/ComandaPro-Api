...
public enum PaymentMethod {
    ...
    private static java.util.List<String> aliases(PaymentMethod pm) {
        return switch (pm) {
            case DINHEIRO -> java.util.List.of("CASH", "MONEY");
            case PIX -> java.util.List.of("PIX");
            case CARTAO_CREDITO -> java.util.List.of("CARTAO_CREDITO", "CREDITO", "CREDIT_CARD");
            case CARTAO_DEBITO -> java.util.List.of("CARTAO_DEBITO", "DEBITO", "DEBIT_CARD");
            case VALE_REFEICAO -> java.util.List.of("VR", "VALE_REFEICAO", "VALE");
        };
    }
}
